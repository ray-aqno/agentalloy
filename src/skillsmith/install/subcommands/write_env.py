...
Base presets use Ollama (port 11434) or LM Studio (port 1234).
llama-server variants (``<preset>-llama-server``) also use port 11434
so the runtime URL is identical regardless of which runner was chosen.
